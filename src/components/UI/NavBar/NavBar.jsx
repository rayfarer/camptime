...
import theme from '../Theme/Theme'; // Update the path
...
export default function NavBar(props) {
    ...
    const memoizedTimer = useMemo(() => <Timer initialTime={props.spawnTimer * 1000} />, [props.spawnTimer]);
                ...
                <Box sx={{ flexGrow: 1 }}>
                    <AppBar position="fixed">
                        <Toolbar>
                            ...
                            <LightTooltip interactive title={<div dangerouslySetInnerHTML={{ __html: tooltips.searchbar }} />} placement="bottom">
                                <Search>
                                    <SearchIconWrapper>
                                        <SearchIcon />
                                    </SearchIconWrapper>
